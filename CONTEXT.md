...
└── services/
    ├── adguardhome.nix             ← network-wide ad-blocking DNS (addblock.veracoechea.com, 10.0.0.2:53, Cloudflare+Quad9 DoT upstream)
